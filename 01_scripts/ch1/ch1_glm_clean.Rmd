...
```{r}
pred_rodent_veg <- ggpredict(burrows_pois_cover, terms = c("grass_forb_perc_scaled", "cover_type"), )

ggplot(pred_rodent_veg, aes(x = x, y = predicted, color = group)) +
  geom_line(size = 1.2) +
  geom_ribbon(aes(ymin = conf.low, ymax = conf.high, fill = group), alpha = 0.2, color = NA) +
  labs(
    title = "Predicted Number of Burrows vs Grass/Forb %",
    x = "Grass/Forb % (scaled)",
    y = "Predicted Number of Burrows",
    color = "Cover Type",
    fill = "Cover Type"
  ) +
  theme_classic()
...
```{r}
pred_rodent_date <- ggpredict(burrows_pois_cover, terms = c("julian.date_scaled", "cover_type"))

ggplot(pred_rodent_date, aes(x = x, y = predicted, color = group)) +
  geom_line(size = 1.2) +
  geom_ribbon(aes(ymin = conf.low, ymax = conf.high, fill = group), alpha = 0.2, color = NA) +
  labs(
    title = "Predicted Number of Burrows vs Julian Date",
    x = "Julian Date (scaled)",
    y = "Predicted Number of Burrows",
    color = "Cover Type",
    fill = "Cover Type"
...
Number of nest-searching queens vs grass/forb, by season

```{r}
pred_nsq_veg <- ggpredict(NSQ_noRE, terms = c("grass_forb_perc_scaled", "bee_season_type"))

ggplot(pred_nsq_veg, aes(x = x, y = predicted)) +
  geom_line(size = 1.2) +
  facet_wrap(~ group) +
  geom_ribbon(aes(ymin = conf.low, ymax = conf.high), alpha = 0.2, color = NA) +
  labs(
    title = "Predicted Number of NSQ vs Grass/Forb %",
    x = "Grass/Forb % (scaled)",
    y = "Predicted Number of NSQ"
  ) +
  theme_classic()
```

Number of nest-searching queens vs floral abundance, by season

```{r}
pred_nsq_floral <- ggpredict(NSQ_noRE, terms = c("bombus_floral_abun_scaled", "bee_season_type"))

ggplot(pred_nsq_floral, aes(x = x, y = predicted)) +
  geom_line(size = 1.2) +
  facet_wrap(~ group) +
  geom_ribbon(aes(ymin = conf.low, ymax = conf.high), alpha = 0.2, color = NA) +
  labs(
    title = "Predicted Number of NSQ vs bombus floral abundance",
...
Number of nest-searching queens vs number of rodent burrows, by season

```{r}
pred_nsq_rodent <- ggpredict(NSQ_noRE, terms = c("num_burrows_scaled", "bee_season_type"))

ggplot(pred_nsq_rodent, aes(x = x, y = predicted)) +
  geom_line(size = 1.2) +
  facet_wrap(~ group) +
  geom_ribbon(aes(ymin = conf.low, ymax = conf.high), alpha = 0.2, color = NA) +
  labs(
    title = "Predicted Number of NSQ vs rodent burrow abundance",
    x = "Number rodent burrows (scaled)",
    y = "Predicted Number of NSQ"
  ) +
  theme_classic()
```
...
Number of workers vs number of nest-searching queens, by season

```{r}
pred_worker_nsq <- ggpredict(worker_negbin, terms = c("nest_searching_queens_scaled", "bee_season_type"))
...
ggplot(pred_worker_nsq, aes(x = x, y = predicted)) +
  ...
  geom_ribbon(aes(ymin = conf.low, ymax = conf.high), alpha = 0.2, color = NA) +
  labs(
    title = "Predicted Number of Workers vs Number of NSQ",
    x = "# NSQ",
    y = "Predicted Number of Workers"
  ) +
  theme_classic()
```
...
```{r}
pred_worker_floral <- ggpredict(worker_negbin, terms = c("bombus_floral_abun_scaled", "bee_season_type"))
...
ggplot(pred_worker_floral, aes(x = x, y = predicted)) +
  ...
  geom_ribbon(aes(ymin = conf.low, ymax = conf.high), alpha = 0.2, color = NA) +
  labs(
    title = "Predicted Number of Workers vs Floral Abundance",
    x = "Floral Abundance",
    y = "Predicted Number of Workers"
  ) +
  theme_classic()
...
```{r}
pred_worker_rodent <- ggpredict(worker_negbin, terms = c("num_burrows_scaled", "bee_season_type"))
...
ggplot(pred_worker_rodent, aes(x = x, y = predicted)) +
  ...
  geom_ribbon(aes(ymin = conf.low, ymax = conf.high), alpha = 0.2, color = NA) +
  labs(
    title = "Predicted Number of Workers vs Rodent Burrow Abundance",
    x = "Burrow Abundance",
    y = "Predicted Number of Workers"
  ) +
  theme_classic()
