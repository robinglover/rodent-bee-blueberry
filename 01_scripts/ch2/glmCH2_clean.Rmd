...
ggplot(pred_veg_df, aes(x = plot_type, y = fit, color = cover_type)) +
  geom_jitter(
    data = surveys,
    aes(x = plot_type, y = grass_forb_perc, color = cover_type),
...
#add date formatted to surveys data frame
surveys <- surveys %>%
  mutate(
...
ggplot(pred_veg_date_df, aes(x = date_formatted, y = fit)) +
  geom_jitter(
    data = subset(surveys, cover_type == "herbaceous" & plot_type == "ditch"),
    aes(x = date_formatted, y = grass_forb_perc),
    width = 0.05,
    height = 0,
    size = 3,
    alpha = 0.2,
...
ggplot(pred_floral_plot_df, aes(y = mean.class, x = plot_type)) +
  geom_jitter(
    data = surveys,
    aes(x = plot_type, y = bombus_floral_abun),
    width = 0.2,
    height = 0,
    size = 3,
    alpha = 0.2,
...
ggplot(pred_floral_date_df, aes(x = date_formatted, y = mean.class, color = plot_type)) +
  geom_jitter(
    data = surveys,
    aes(x = date_formatted, y = bombus_floral_abun, color = plot_type),
    width = 0.05,
    height = 0,
    size = 3,
    alpha = 0.2,
    inherit.aes = FALSE) +
  geom_line(linewidth = 1.5) +
  geom_ribbon(aes(ymin = asymp.LCL, ymax = asymp.UCL, fill = plot_type, group = plot_type), alpha = 0.2, color = NA) +
  scale_x_date(date_breaks = "1 month", date_labels = "%b") + # Format x-axis to show Month names (e.g., May, Jun, Jul) 
...
ggplot(pred_rodent_veg_df, aes(x = plot_type, y = fit, color = cover_type)) +
  geom_jitter(
    data = surveys,
    aes(x = plot_type, y = num_burrows, color = cover_type),
    position = position_jitterdodge(
    jitter.width = 0.08,
    dodge.width = 0.6),
    size = 3,
...
ggplot(pred_nsq_plottype_df, aes(x = plot_type, y = cond_fit)) +
  geom_jitter(
    data = subset(surveys, cover_type == "herbaceous" & bee_season_type == "nestsearching"),
    aes(x = plot_type, y = nest_searching_queens),
    width = 0.2,
    height = 0,
    size = 3,
    alpha = 0.2,
...
ggplot(pred_nsq_covertype_df, aes(x = cover_type, y = cond_fit)) +
  geom_jitter(
    data = subset(surveys, plot_type == "ditch" & bee_season_type == "nestsearching"),
...
ggplot(pred_nsq_floral_df,
       aes(x = bombus_floral_abun_scaled,
           y = cond_fit)) +
  geom_jitter(
    data = subset(surveys, cover_type == "herbaceous" & bee_season_type == "nestsearching" & plot_type == "ditch"),
...
ggplot(pred_worker_plottype_df, aes(x = plot_type, y = fit)) +
  geom_jitter(
    data = subset(surveys, cover_type == "herbaceous" & bee_season_type == "worker"),
    aes(x = plot_type, y = workers),
    width = 0.2,
    height = 0,
    size = 3,
    alpha = 0.2,
...
ggplot(pred_worker_covertype_df, aes(x = cover_type, y = fit)) +
  geom_jitter(
    data = subset(surveys, plot_type == "ditch" & bee_season_type == "worker"),
...
ggplot(pred_worker_floral_df, aes(x = bombus_floral_abun_scaled, y = fit, color = plot_type)) +
  geom_jitter(
    data = subset(surveys, cover_type == "herbaceous" & bee_season_type == "worker"),
    aes(x = bombus_floral_abun_scaled, y = workers, color = plot_type),
    width = 0.05,
    height = 0,
    size = 3,
    alpha = 0.2,
...
ggplot(pred_worker_season_df, aes(x = bee_season_type, y = fit)) +
  geom_jitter(
    data = subset(surveys, plot_type == "ditch" & cover_type == "herbaceous"),
